              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                {categories.map((category) => (
                  <button
                    ...
                    className={`px-6 py-3 rounded-full border-2 text-sm font-bold uppercase tracking-wider transition-all duration-300 ${activeCategory === category
            ...
            <div className="lg:w-1/2">
              <Reveal delay={0.3}>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <img src="https://anjaneyauniversity.ac.in/blog/wp-content/uploads/2024/09/image-2-1210x700.webp" alt="Detail 2" className="rounded-sm w-full h-64 object-cover mt-8" />
                </div>
              </Reveal>
            </div>
          </div>
